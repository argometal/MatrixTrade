 ...
 * Independent of Active/Archive tabs. Births Active (DEBT-AF03-01).
 * Actions: New Chaos Deck, New Folder only.
 */
  ...
  return (
    <div className="space-y-3 p-3" role="dialog" aria-label="Create">
      ...
      <p className="text-xs leading-relaxed text-zinc-500">
        Global action — not birth-into-Active/Archive as separate worlds. New work starts as Active.
      </p>
