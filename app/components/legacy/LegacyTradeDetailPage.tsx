...
/** Classic light-theme trade detail page — preserved for reference. */
export function LegacyTradeDetailPage({
  trade,
  experiment,
  monthly,
  setups,
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      ...
      {trade.lessons && <p className="text-sm text-zinc-600">{trade.lessons}</p>}
      ...
      {trade.status !== "closed" && (
        <form
          ...
          className="space-y-3 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm"
        >
