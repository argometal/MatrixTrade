  ...
  const body = (
    <div className="space-y-6 px-4 py-4 lg:px-6 lg:py-6">
          ...
          <nav className="flex flex-wrap gap-4 border-t border-zinc-800 pt-4 text-sm">
            <Link href="/mta/playbook" className="text-zinc-500 hover:text-zinc-300">
              Playbook Lab →
            </Link>
            <Link href="/mta/stats?tab=mistakes" className="text-zinc-500 hover:text-zinc-300">
              Mistakes →
            </Link>
            <Link href="/mta/stats?tab=journal" className="text-zinc-500 hover:text-zinc-300">
              Journal →
            </Link>
          </nav>
        </div>
