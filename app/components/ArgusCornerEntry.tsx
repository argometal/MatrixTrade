...
export function ArgusCornerEntry() {
  ...
  return (
    <Link
      ...
      className="group fixed right-4 top-4 z-50 rounded-xl shadow-lg shadow-zinc-900/10 transition hover:scale-105 hover:shadow-teal-500/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-50 sm:right-6 sm:top-6"
    >
      <ArgusMark />
