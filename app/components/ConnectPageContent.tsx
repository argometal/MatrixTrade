...
function QrCard({ item }: { item: ConnectItem }) {
  return (
    <div className="flex flex-col items-center rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
      <p className="mb-1 text-center text-sm font-semibold text-zinc-800">{item.name}</p>
      ...
      <p className="mt-4 break-all text-center font-mono text-xs text-blue-700">{item.url}</p>
