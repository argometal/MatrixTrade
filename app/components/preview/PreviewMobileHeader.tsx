...
export function PreviewMobileHeader({ pendingInboxCount = 0 }: { pendingInboxCount?: number }) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-30 flex h-[var(--mt-mobile-header)] max-w-[100vw] items-center justify-between gap-2 overflow-hidden border-b border-zinc-800 bg-zinc-950/95 px-3 backdrop-blur lg:hidden">
