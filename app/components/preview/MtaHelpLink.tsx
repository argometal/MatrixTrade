...
/**
 * Contextual ? — Argus-style help for the UI you’re looking at.
 * Moves doctrine / workflow copy out of the primary chrome.
 */
          ...
          >
            <header className="flex shrink-0 items-start justify-between gap-3 border-b border-zinc-800/80 px-4 py-3">
              <div className="min-w-0">
                ...
                <h2
                  id={titleId}
                  className="mt-0.5 text-base font-semibold text-zinc-50"
                >
                  {section?.title ?? label}
                </h2>
              </div>
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-4 py-3">
              {section ? (
                ...
                <p className="text-sm text-zinc-500">
                  No dedicated tip for this view yet. Use the page Help (?) for
                  the overview.
                </p>
              )}
            </div>
