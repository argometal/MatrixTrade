              ...
              <ul className="mt-3 space-y-2 text-sm">
                {data.openSummary.positions.map((p) => (
                  <li key={p.id} className="flex justify-between text-zinc-400">
                    <Link href={`/mxt/trades/${p.id}`} className="hover:text-violet-300">
            ...
            {data.recentClosed.length === 0 ? (
              ...
              data.recentClosed.map((t) => (
                <li key={t.id} className="flex justify-between">
                  <Link href={`/mxt/trades/${t.id}`} className="text-zinc-400 hover:text-violet-300">
                    {t.ticker}
                  </Link>
