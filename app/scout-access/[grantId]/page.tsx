...
import { buildScopedAiUrls, validateScopedAiGrant } from "@/lib/scoped-ai-grants";
    ...
    return (
      <main className="mx-auto max-w-2xl px-4 py-10 text-zinc-100">
        ...
        <p className="mt-4 text-sm text-zinc-500">
          Create a new link from the Stock Profile page in MatrixTrade.
        </p>
      </main>
    );
  }
    ...
    <main className="mx-auto max-w-3xl px-4 py-8 text-zinc-100">
      <header className="border-b border-zinc-800 pb-5">
        ...
        <h1 className="mt-1 text-2xl font-semibold">
          {grant.ticker} · {grant.stockProfileId}
        </h1>
      ...
      <section className="mt-6 space-y-3 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm text-zinc-400">
          ...
          <li>Apply the proposal in MatrixTrade Inbox — changes are never auto-applied.</li>
        </ol>
      </section>
