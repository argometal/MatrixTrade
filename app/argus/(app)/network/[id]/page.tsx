...
import { NetworkRelationshipMetricsDisplay } from "@/app/argus/components/NetworkRelationshipMetricsDisplay";
    ...
    <>
      ...
      <Card className="mb-4">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <span className={`text-sm font-medium ${RELATIONSHIP_STATUS_COLORS[relationshipStatus]}`}>
        ...
        <NetworkRelationshipMetricsDisplay entity={entity} />
