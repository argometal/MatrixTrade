      ...
      <V2MobileMenuProvider counts={navCounts}>
        <div className="min-h-screen bg-zinc-950">
          ...
          <div className="flex h-dvh min-h-0 flex-col overflow-hidden lg:min-h-screen lg:h-auto lg:overflow-visible lg:pl-56 xl:pl-60">
            ...
            />
            <main className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-hidden pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:overflow-y-visible lg:pb-8 [&:has(.v2-inbox-shell)]:pb-0 lg:[&:has(.v2-inbox-shell)]:pb-0 [&:has(.v2-browse-shell)]:pb-0 lg:[&:has(.v2-browse-shell)]:pb-0">
              {children}
            </main>
          </div>
        </div>
