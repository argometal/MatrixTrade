    ...
    <div>
      <div className="mb-3">
        ...
        <p className="mt-1 text-xs text-zinc-500">
          Local view around {entityName} — not the full universe. Click a node to focus only its neighbors; Back or
          Full neighborhood to return. ⌘/Ctrl+click opens the entity.
        </p>
      </div>
      <V2KnowledgeGraph
        nodes={graph.nodes}
