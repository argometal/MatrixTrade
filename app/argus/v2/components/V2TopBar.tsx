      ...
      <div className="flex items-center gap-2 px-3 py-2.5 sm:gap-3 sm:px-4 sm:py-3 lg:px-6">
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className={`block truncate text-[10px] leading-tight ${open ? "text-violet-300/90" : "text-zinc-500"}`}>
          ...
          >
            <span className="flex flex-col gap-[3px]">
              <span className={`block h-0.5 w-3.5 rounded-full bg-current transition ${open ? "translate-y-[5px] rotate-45" : ""}`} />
