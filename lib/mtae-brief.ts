...
export function buildMtaeProtocolBrief(presets: MtaeTimeframeMapPreset[]): string {
  ...
  return [
    ...
    "",
    "==================================================",
    "APPLY JSON CONTRACT (technical-assessment)",
    "==================================================",
    "Serialize exact JSON keys — Evidence First labels are display-only.",
    "REQUIRED nested paths:",
    "- stockProfileId, ticker",
    "- timeframeRoles.strategic_tf | opportunity_tf | refinement_tf | execution_tf",
    "- perTimeframe[] (non-empty)",
    "- perTimeframe[].timeframe",
    "- perTimeframe[].trend (bullish|neutral|bearish)",
    ...
    "Full enums + minimum valid example: Control → Train AI → Apply schema contract",
    "(or Control → Library → MTAE → technical-assessment schema + min example).",
    "",
    "CALIBRATION",
