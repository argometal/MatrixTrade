...
export function buildMtaeProtocolBrief(presets: MtaeTimeframeMapPreset[]): string {
  ...
  return [
    ...
    "probableTarget / extendedTarget require defendable evidence on the charts provided.",
    "If the defensible probableTarget is already reached: say TARGET REACHED — do NOT invent a higher",
    "extended/probable level from plausibility, Fib, or open sky. See TARGET DISCIPLINE in Mechanics.",
    "",
    "NOT THIS MODULE",
    ...
    "",
    "==================================================",
    "EVIDENCE FIRST PRESENTATION (DEFAULT — mandatory)",
    "==================================================",
    "Goal: compare 20–30 tickers quickly. First screen = technical evidence only.",
    "Explanation is secondary. Never mix narrative into timeframe blocks.",
    "",
    "TIMEFRAME OUTPUT — every TF (6M, 3M, 1M, 1W, …) in EXACTLY this order:",
    "  • Supports",
    "  • Resistances / Targets",
    "  • Bias",
    "  • Confidence",
    "Maximum ONE short sentence of explanation if absolutely necessary.",
    "Do NOT include in timeframe blocks: market narrative, historical discussion,",
    "psychology, capital allocation, trade management, or thesis explanation.",
    "",
    "INTEGRATED SECTION — only AFTER every timeframe is listed:",
    "  • Overall Technical Thesis",
    "  • Momentum Assessment (expansion quality — NOT trading decisions)",
    "  • Structural Risks",
    "  • Important Notes",
    "",
    "PROFILE NOTES — any structural comments, observations, educational text,",
    "or longer reasoning MUST appear AFTER Integrated. Never interrupt TF analysis.",
    "",
    "SCOUT SEPARATION — MTAE must NEVER produce:",
    "  Go · Wait · No Trade · Entry optimization · Position sizing · Capital allocation.",
    "Those belong exclusively to Scout.",
    "",
    "Explain Mode: only when the human asks why a specific level was chosen.",
    "",
