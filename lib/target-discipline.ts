...
export function buildTargetDisciplineBrief(): string {
  return [
    ...
    "   Does NOT invent T2. Does NOT auto-Accept as MAF.",
    "   Hindsight reconstruction of a better entry ≠ automatic T0 mutation.",
    "   Do NOT rewrite T0 from later price/P&L during analysis.",
    "   Explicit audited T0 repair/reconstruction is allowed only via Apply type thesis-t0-repair",
    "   (repairKind reconstructed|corrected + note + evidence) — never silent invent / never inherit another Plan's freeze.",
    "",
