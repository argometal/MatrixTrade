...
export const STOCK_CASE_BOOT_REQUEST = [
  ...
  "2. initialScout (REQUIRED tactical window): plannedEntry, stopPrice, targetPrice (mandatory); optional executableEntry (=plannedEntry), originalEntry, participationBlocker, reviseIf[], supportLevel, validFrom, validUntil, thesis",
  "",
  "Creation without plannedEntry + stopPrice + targetPrice is REJECTED.",
  "P10 capture (strongly recommended on WAIT/PASS): participationBlocker, reviseIf[], originalEntry (defaults to plannedEntry).",
  "",
  ...
  "Optional: thesis, notes, historicalAnalysis[], status; initialScout.participationBlocker, reviseIf, originalEntry, executableEntry",
  "",
