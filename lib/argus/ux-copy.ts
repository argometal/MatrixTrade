...
export const TAGS = {
  ...
  pickerHintOnNote: "Reuse a Tag from this Topic or the universe. Create new only if nothing fits.",
  pickerHintWithFlag: "Checkbox = on this note. Flag = journal-wide Tracker (optional).",
  sectionTopic: "In this Topic",
  sectionTopicLinked: "In linked Topics",
  sectionRecent: "Recently used",
  sectionUniverse: "All tags",
  sectionMatches: "Matches",
  searchUniverseHint: "Search to browse the full Tag universe",
  createAfterSearch: "Create new tag",
...
export const INBOX = {
  ...
  /** @deprecated Convert-to-record removed from Inbox UI — use Link + Archive. */
  convertRecord: "Convert to record (legacy)",
  archive: "Archive",
  saveLink: "Save link",
  convertHeading: "Convert to record (deprecated)",
  convertHint: "Deprecated — prefer Link + Archive. If used, opens the journal note (not a dead end).",
  actionsRemaining: "Actions remaining",
  noActions: "No actions — item is archived (or finished as a journal note).",
  fromLabel: "From",
  toLabel: "To",
...
export const TOPIC_MATCH_TAGS = {
  heading: "Topic Tags",
  hint: "Search the Tag universe to reuse existing Tags, or type a new one. Save attaches to this Topic.",
  placeholder: "Add a tag…",
  add: "Add",
  save: "Save Tags",
  browseUniverse: "Browse / search universe",
...
export const EVENT_MATCH_TAGS = {
  heading: "Event Tags",
  hint: "Search the Tag universe to reuse existing Tags, or type a new one. Save attaches to this Event (and Note evidence when needed).",
  placeholder: "Add a tag…",
  add: "Add",
  save: "Save Tags",
  browseUniverse: "Browse / search universe",
