...
import { deleteAuthConfigured, linkedEntityIdsRequireAuthenticator } from "@/lib/argus/delete-link-check";
import type { Entity } from "@/lib/argus/types";

export { deleteAuthConfigured, linkedEntityIdsRequireAuthenticator } from "@/lib/argus/delete-link-check";
