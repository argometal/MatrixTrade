...
export function buildEntrySolverMechanicsBrief(): string {
  return [
    ...
    "6. ENTRY — select executable entry only after 1–5.",
    "   Conceptual quality: R quality × participation quality (structure, not fake formula).",
    ...
    "WHY THIS ENTRY must reconstruct: target → stop → R comparison → participation → entry.",
