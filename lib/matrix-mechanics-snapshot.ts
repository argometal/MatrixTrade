...
export const MATRIX_MECHANICS_REVISION = 48;
...
export function buildMatrixMechanicsSnapshot(): string {
  return [
    ...
    "- thesis-t0 — Plan-specific T0 write/update path with correctionAudit; never share freeze across Plans; hindsight alone insufficient",
    ...
    "- Stopping the Entry Solver at maximumEntry without R map + participation",
    "- ZONE → arbitrary midpoint/round number → post-hoc R justification",
    "- Treating Fib/projection alone as probable target",
    "- Maximizing theoretical R while ignoring fill/participation (MAX R ≠ OPTIMAL ENTRY)",
    "- Auto-executing deeper Opportunity 2 solely because R is higher",
