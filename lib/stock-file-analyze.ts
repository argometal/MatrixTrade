...
2. TARGET DISCIPLINE — If probableTarget is reached: state TARGET REACHED. LIVE new entry against that T alone → REASSESSMENT (do not invent T2). EVALUATION of the opportunity that produced T may still run Entry Solver R map against T. Plausibility ≠ evidence.
