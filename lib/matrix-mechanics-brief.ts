...
export function buildMatrixMechanicsBrief(
  ...
  return [
    ...
    "Apply schema freshness: Control → Apply → Apply schema contract must show schemaVersion 2026-09-15.mxt-15-21-ole-init (and acceptedTypes must list layered-entry-update, thesis-t0 and plan-delete). If missing → STALE paste/build.",
    ...
    "OLE under INSUFFICIENT fill evidence: distribute authorized risk across the defensible battle zone (default 30/40/30); do not pretend one exact price is statistically optimal.",
    ...
    "- When FILL EVIDENCE: INSUFFICIENT: use uncertainty-distributed default 30% starter / 40% preferred / 30% deep_pullback — NOT false-precision 20/70/10.",
