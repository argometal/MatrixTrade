...
assert.match(start, /Control → Mechanics → copy row MTA Mechanics|Mechanics — copy row MTA Mechanics/);
assert.doesNotMatch(start, /Correct: Control → MTAE/);
assert.match(start, /Control → Start Here|FORBIDDEN invented UI:[\s\S]*Control → Start Here/);
