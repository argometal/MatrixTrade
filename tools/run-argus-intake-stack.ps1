...
Write-Host ""
Write-Host "Verify local API:"
Write-Host "  npx tsx tools/test-email-inbox.ts http://localhost:3002"
Write-Host ""
Write-Host "If intake.argometal.dev returns 525, use quick tunnel + redeploy Worker:"
Write-Host "  cloudflared tunnel --url http://localhost:3002"
Write-Host "  npx tsx tools/deploy-argus-email-worker.ts https://YOUR-URL.trycloudflare.com/api/argus/email-inbox"
Write-Host ""
Write-Host "See md/argus/email-intake-e2e.md"
