══════════════════════════════════════════════════════════════
SNAPSHOT — árbol completo hasta 41a8b7fba1f43ae364668a6cf95a361aaf023e1e
(Incluye archivos creados por primera vez en el primer commit)
══════════════════════════════════════════════════════════════
...
+!.yarn/versions
+
+# portable Node (copy locally — see runtime/README.md)
+/runtime/node/
+
+# next.js
+/.next/
...
+next-env.d.ts
+
+# Obsidian trade notes (your data — keep local)
+/vault/Trades/*.md
+*.matrixtrade.tmp
+
+# OS / editor
...
diff --git a/MatrixTrade-IP01.md b/MatrixTrade-IP01.md
new file mode 100644
index 0000000..f1a7c9d
--- /dev/null
+++ b/MatrixTrade-IP01.md
@@ -0,0 +1,73 @@
...
+  );
+}
diff --git a/app/trades/[id]/page.tsx b/app/trades/[id]/page.tsx
new file mode 100644
index 0000000..6ae5856
--- /dev/null
...
+  );
+}
diff --git a/app/trades/new/page.tsx b/app/trades/new/page.tsx
new file mode 100644
index 0000000..dd4c7b0
--- /dev/null
+++ b/app/trades/new/page.tsx
@@ -0,0 +1,65 @@
+import Link from "next/link";
...
+  );
+}
diff --git a/app/trades/page.tsx b/app/trades/page.tsx
new file mode 100644
index 0000000..81c11b2
--- /dev/null
+++ b/app/trades/page.tsx
@@ -0,0 +1,98 @@
+import Link from "next/link";
...
+pause
diff --git a/lib/calculate.ts b/lib/calculate.ts
new file mode 100644
index 0000000..58de730
--- /dev/null
+++ b/lib/calculate.ts
@@ -0,0 +1,69 @@
...
+}
diff --git a/lib/obsidian.ts b/lib/obsidian.ts
new file mode 100644
index 0000000..a36f5d0
--- /dev/null
+++ b/lib/obsidian.ts
@@ -0,0 +1,217 @@
...
diff --git a/publish-github.bat b/publish-github.bat
new file mode 100644
index 0000000..cd63efb
--- /dev/null
+++ b/publish-github.bat
@@ -0,0 +1,90 @@
+@echo off
...
+pause
diff --git a/repair-install.bat b/repair-install.bat
new file mode 100644
index 0000000..68bc5d0
--- /dev/null
+++ b/repair-install.bat
@@ -0,0 +1,27 @@
+@echo off
+setlocal
+set "ROOT=%~dp0"
...
diff --git a/setup-runtime.bat b/setup-runtime.bat
new file mode 100644
index 0000000..cad193c
--- /dev/null
+++ b/setup-runtime.bat
@@ -0,0 +1,36 @@
+@echo off
...
diff --git a/vault/Trades/.gitkeep b/vault/Trades/.gitkeep
new file mode 100644
index 0000000..e69de29


══════════════════════════════════════════════════════════════
CAMBIOS LOCALES — aún no en el commit TARGET
(Archivos nuevos sin commit aparecen aquí)
══════════════════════════════════════════════════════════════

diff --git a/publish-github.bat b/publish-github.bat
index cd63efb..8553847 100644
--- a/publish-github.bat
+++ b/publish-github.bat
...
diff --git a/dev/null b/COMPARTIR-CON-IA.md
new file mode 100644
--- /dev/null
+++ b/COMPARTIR-CON-IA.md
