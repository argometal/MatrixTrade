...
**Open IA review (metrics after event↔topic link):** [`event-topic-signals-metrics-ia-handoff.md`](event-topic-signals-metrics-ia-handoff.md) — Proposed; awaiting confirmation before code.
