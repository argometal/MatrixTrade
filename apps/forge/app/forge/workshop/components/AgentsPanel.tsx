  ...
  return (
    <section className="space-y-4 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-4">
      ...
      <p className={`text-xs ${AF_TEXT.metadata}`}>
        Bundled copy: <code className="text-zinc-500">MatrixTrade/workshop-agents</code> (monolith) or{" "}
        <code className="text-zinc-500">apps/forge/workshop-agents</code> when running{" "}
        <code className="text-zinc-500">dev:forge</code>. Requires local Forge on this PC — not Vercel cloud.
      </p>
